...
public class AmplitudeTest {
  ...
  private AmplitudeIntegration.Provider mockProvider =
      new AmplitudeIntegration.Provider() {
        @Override
  ...
  public void trackWithListGroups() throws JSONException {
    Map<String, Object> options =
        new ValueMap()
            .putValue(
                "groups", new ValueMap().putValue("sports", Arrays.asList("basketball", "tennis")));
    integration.track(
        (new TrackPayload.Builder())
            .anonymousId("foo")
            .event("foo")
  ...
  public void trackWithRevenue() {
    ...
    verify(amplitude)
        .logEvent(
            eq("foo"), toStringEq(properties.toJsonObject()), isNull(JSONObject.class), eq(false));
  ...
  @Test
  public void trackWithRevenueV2PriceAndQuantity() {
    integration.useLogRevenueV2 = true;
  ...
  public void identifyWithListGroups() {
    ...
    verify(amplitude).setUserProperties(toStringEq(traits.toJsonObject()));
    verify(amplitude)
        .setGroup(eq("sports"), toStringEq(new JSONArray().put("basketball").put("tennis")));
  }
  ...
  public void identifyWithIncrementedTraits() {
    ValueMap settings =
        new ValueMap()
            .putValue(
                "traitsToIncrement", Arrays.asList("double", "float", "integer", "long", "string"));
    ...
    Traits traits =
        createTraits("foo")
            ...
            .putValue("string", s);
    IdentifyPayload payload =
        (new IdentifyPayload.Builder()).anonymousId("anonId").userId("foo").traits(traits).build();
    integration.identify(payload);
  ...
  public void identifyWithSetOnce() {
    ValueMap settings =
        new ValueMap()
            .putValue(
                "traitsToSetOnce", Arrays.asList("double", "float", "integer", "long", "string"));
    ...
    Traits traits =
        createTraits("foo")
            ...
            .putValue("string", s);
    IdentifyPayload payload =
        new IdentifyPayload.Builder().userId("foo").anonymousId("anonId").traits(traits).build();
    integration.identify(payload);
  ...
  public void screenTrackAllPages() {
    ...
    integration.screen(
        (new ScreenPayload.Builder()).anonymousId("foo").category("bar").name("baz").build());
  ...
  public void screenTrackAllPagesV2() throws JSONException {
    ...
    integration.screen(
        (new ScreenPayload.Builder())
            ...
            .properties(properties)
            .build());
    verifyAmplitudeLoggedEvent(
        "Loaded a Screen", new JSONObject().put("name", "foo").put("bar", "baz"));
  }

  @Test
  public void group() {
    GroupPayload payload =
        (new GroupPayload.Builder()).userId("foo").groupId("testGroupId").build();
    ...
    verify(amplitude)
        .groupIdentify(eq("[Segment] Group"), eq("testGroupId"), identifyEq(expectedIdentify));
  }
  ...
  public void groupWithGroupName() {
    ...
    GroupPayload payload =
        (new GroupPayload.Builder()).userId("foo").groupId("testGroupId").traits(traits).build();
    ...
    verify(amplitude)
        .groupIdentify(eq("testName"), eq("testGroupId"), identifyEq(expectedIdentify));
  }
  ...
  public void groupWithGroupNameSettings() {
    ...
    Traits traits =
        new Traits()
            .putValue("company", "Segment")
            .putValue("companyType", "data")
            .putValue("members", 80);
  ...
  public void groups() throws JSONException {
    assertNull(
        AmplitudeIntegration.groups(
            (new TrackPayload.Builder()).userId("foo").event("foo").build()));
    assertNull(
        AmplitudeIntegration.groups(
            (new TrackPayload.Builder())
                .userId("foo")
    ...
    assertNull(
        AmplitudeIntegration.groups(
            (new TrackPayload.Builder()).userId("foo").event("foo").integrations(options).build()));
    assertNull(
        AmplitudeIntegration.groups(
            (new TrackPayload.Builder())
                .userId("foo")
    ...
    assertEquals(
        (new JSONObject()).put("foo", "bar").toString(),
        AmplitudeIntegration.groups(
                (new TrackPayload.Builder())
                    .userId("foo")
                    .event("foo")
  ...
  private void verifyAmplitudeLoggedEvent(String event, JSONObject jsonObject) {
    verify(amplitude)
        .logEvent(eq(event), toStringEq(jsonObject), isNull(JSONObject.class), eq(false));
  }
  ...
  private static class IdentifyEqArgumentMatcher implements ArgumentMatcher<Identify> {
    ...
    public boolean matches(Identify other) {
      ...
      return (expected
          ...
          .toString()
          .equals(other.getUserPropertiesOperations().toString()));
    }
