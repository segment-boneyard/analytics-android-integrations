...
public class SpecListFragment extends Fragment {
    ...
    private void setupSpecsUI(){
        ...
        SpecClickListener specClickListener = string -> {
            ...
            getFragmentManager().beginTransaction().replace(R.id.parentContainer, specDetailFragment)
    ...
    private void trackAppLifeCycle(){
        binding.trackAppLifecycle.setOnCheckedChangeListener((buttonView, isChecked) -> {
            SharedPreferences.Editor editor = getActivity()
                    .getSharedPreferences(getString(R.string.PACKAGE_NAME), MODE_PRIVATE).edit();
            if(isChecked){
        ...
        SharedPreferences prefs = getContext().getSharedPreferences(getString(R.string.PACKAGE_NAME), MODE_PRIVATE);
